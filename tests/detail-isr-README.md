...
- [Commerce-UI case study, Vercel, November 2023](https://vercel.com/customers/commerceui-headless-shopify-nextjs): agency/vendor account with multiple concurrent platform changes and no controlled SEO attribution. It is not evidence of an expected ranking/revenue uplift for Coupoonat.
